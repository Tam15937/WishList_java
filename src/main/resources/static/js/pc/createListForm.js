        ...
        <div class="wishlist-content">
            <form class="list-form" @submit.prevent="submitForm">
                ...
                <div style="display: flex; gap: 10px;">
                    <button type="submit" class="save-list-btn">Создать список</button>
                    <button type="button" @click="cancelCreate" class="cancel-btn" style="background: #757575;">Отмена</button>
                </div>
            </form>
        </div>
    `
